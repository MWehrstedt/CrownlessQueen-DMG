...
#define ENEMY_BOSSDBG_HITBOX_SIZE_X 13
...
#define GAME_STATE_PAUSING 0b10000001
#define GAME_STATE_UNPAUSING 0b10000010
...
#define HERO_TIMER_HURT (20)
#define HERO_TIMER_INVULNERABILITY (60)
#define HERO_TIMER_SIDESTEP_MAX (12)
